...
describe TicketTypesController do
  ...
  describe "GET index" do
    it "assigns all ticket_types as @ticket_types" do
      ...
      assigns(:ticket_types).should eq([ticket_type])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested ticket_type as @ticket_type" do
      ...
      assigns(:ticket_type).should eq(ticket_type)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new ticket_type as @ticket_type" do
      ...
      assigns(:ticket_type).should be_a_new(TicketType)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created ticket_type as @ticket_type" do
        post :create, {:ticket_type => valid_attributes}, valid_session
        assigns(:ticket_type).should be_a(TicketType)
        assigns(:ticket_type).should be_persisted
      end

      it "redirects to the created ticket_type" do
        post :create, {:ticket_type => valid_attributes}, valid_session
        response.should redirect_to(TicketType.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved ticket_type as @ticket_type" do
        ...
        TicketType.any_instance.stub(:save).and_return(false)
        post :create, {:ticket_type => {}}, valid_session
        assigns(:ticket_type).should be_a_new(TicketType)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested ticket_type" do
        ticket_type = TicketType.create! valid_attributes
        # Assuming there are no other ticket_types in the database, this
        # specifies that the TicketType created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        TicketType.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => ticket_type.to_param, :ticket_type => {'these' => 'params'}}, valid_session
      end
      ...
      it "redirects to the ticket_type" do
        ticket_type = TicketType.create! valid_attributes
        put :update, {:id => ticket_type.to_param, :ticket_type => valid_attributes}, valid_session
        response.should redirect_to(ticket_type)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the ticket_type as @ticket_type" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        TicketType.any_instance.stub(:save).and_return(false)
        put :update, {:id => ticket_type.to_param, :ticket_type => {}}, valid_session
        assigns(:ticket_type).should eq(ticket_type)
      end
